...
// Update project
router.put('/:id', validate(projectSchemas.update), asyncHandler(async (req, res) => {
  const {
    code,
    name,
    client,
...
router.post('/:id/clone', validate(projectSchemas.clone), asyncHandler(async (req, res) => {
